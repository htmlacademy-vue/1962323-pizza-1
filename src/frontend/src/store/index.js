...
export default new Vuex.Store({
  ...
  actions: {
    ...
    async getIngredientsData({ commit, dispatch }) {
      ...
      dispatch("PizzaConstructor/setClassesToElems", "ingredients", {
        root: true,
      });
    },
    ...
    async getMiscData({ commit, dispatch }) {
      ...
      commit(SET_ENTITY, { module: "Order", entity: "cart", value: misc });
