<template>
    ...
    <div class="layout__content">
      ...
      <div class="layout__address">
        <div class="sheet address-form layout__address" v-for="address in addresses" :key="address.id">
          <div>
            <div class="address-form__header">
              <b>Адрес №{{address.id}}</b>
              <div class="address-form__edit">
                <button type="button" class="icon" @click="toggleAddress(address.id)"><span class="visually-hidden">Изменить адрес</span></button>
              </div>
            </div>
      ...
      <div class="layout__button">
        <button type="button" class="button button--border" @click="toggleAddress('new')">Добавить новый адрес</button>
      </div>
    </div>
  </main>
</template>
...
export default {
    ...
    methods:{
      toggleAddress(addressId){
        this.toggleInfo = {...this.toggleInfo, [addressId]: !this.toggleInfo[addressId]}
      },
